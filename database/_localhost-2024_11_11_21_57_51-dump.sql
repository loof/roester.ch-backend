...
INSERT INTO `cart_item` VALUES (112,2,14,1,12),(184,1,34,1,12),(185,1,35,1,12),(186,1,1,1,20),(187,1,1,1,12);
...
CREATE TABLE `position` (
  ...
  KEY `FKisooitr3kygqngrgbmnb6mnhj` (`variant_id`),
...
CREATE TABLE `shipping_method` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKbn44d6iwmji6nubr6wmm6uuk3` (`carrier_id`),
  CONSTRAINT `FKbn44d6iwmji6nubr6wmm6uuk3` FOREIGN KEY (`carrier_id`) REFERENCES `carrier` (`id`)
...
INSERT INTO `shipping_method` VALUES (1,NULL,NULL,NULL,'3-5 Werktage',2.00,34.30,24.00,'Grossbrief bis B4',2.00,1000.00,1),(2,NULL,NULL,NULL,'3-5 Werktage',2.00,24.00,16.60,'Midibrief bis B5',1.40,500.00,1),(3,NULL,NULL,NULL,'3-5 Werktage',55.00,55.00,95.00,'Paket bis 2kg',8.50,2000.00,1);
...
INSERT INTO `status` VALUES (12,'Cancelled'),(13,'Delivered'),(10,'Paid'),(15,'Preparing Shipment'),(14,'Returned'),(11,'Shipped'),(9,'Waiting for payment');
...
INSERT INTO `variant` VALUES (10,NULL,NULL,'560',0.56,1,5,NULL,NULL,NULL,560.00,_binary '\0',_binary '\0',NULL,1.00,1.00,1.00),(11,NULL,'<null>','320',0.30,1,5,NULL,NULL,NULL,300.00,_binary '\0',_binary '','Briefpost',1.10,1.00,1.00),(12,NULL,'<null>','320',0.30,1,1,NULL,NULL,NULL,300.00,_binary '\0',_binary '','Briefpost',1.00,1.00,1.00),(14,NULL,NULL,'320',0.32,1,2,NULL,NULL,NULL,320.00,_binary '\0',_binary '\0',NULL,1.00,1.00,1.00),(15,NULL,NULL,'560',0.56,1,2,NULL,NULL,NULL,560.00,_binary '\0',_binary '\0',NULL,1.00,1.00,1.00),(16,NULL,NULL,'320',0.32,1,3,NULL,NULL,NULL,320.00,_binary '\0',_binary '\0',NULL,1.00,1.00,1.00),(17,NULL,NULL,'560',0.56,1,3,NULL,NULL,NULL,560.00,_binary '\0',_binary '\0',NULL,1.00,1.00,1.00),(18,NULL,NULL,'320',0.32,1,4,NULL,NULL,NULL,320.00,_binary '\0',_binary '\0',NULL,1.00,1.00,1.00),(19,NULL,NULL,'560',0.56,1,4,NULL,NULL,NULL,560.00,_binary '\0',_binary '\0',NULL,1.00,1.00,1.00),(20,NULL,NULL,'560',0.56,1,1,NULL,NULL,NULL,560.00,_binary '\0',_binary '\0',NULL,1.00,1.00,1.00);
...
-- Dump completed on 2024-11-11 21:57:52
